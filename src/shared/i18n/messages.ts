...
const ko = {
  ...
  tourFinishedAllHeading: '두 경로를 모두 둘러봤습니다',
  tourFinishedAllBody: '이제 바로 써 보세요. 이 안내는 잠시 뒤 사라집니다.',
...
const en: Record<MessageKey, string> = {
  ...
  tourFinishedAllHeading: 'You have been through both walkthroughs',
  tourFinishedAllBody: 'You are all set — this card closes on its own in a moment.',
